...
- Self-hosted Go signaling service with no accounts or file storage. The first version trusts server-forwarded DTLS fingerprints; SPAKE2 authentication is not implemented.
