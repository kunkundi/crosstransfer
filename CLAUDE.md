...
- CI 曾因账单阻塞，推送 `62c43f4` 后已恢复：Server `35654293364` 成功，Desktop `35654293360` 的 Linux 全流程成功。Windows 源码校验的 CRLF 与 macOS 测试证书 AKI 已修复为 `726bc03`，待矩阵确认；Windows OpenSSL CRT 修复尚未完成远程验证。Android/iOS 正在执行模拟器步骤。
