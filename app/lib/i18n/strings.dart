...
const Map<String, String> _zh = {
  ...
  'recv.submit_hint': '按 Enter 开始接收',
  'recv.paste_receive': '粘贴并接收',
  'recv.start': '接收',
  'recv.paste': '粘贴链接或取件码',
  'recv.save_to': '保存到',
  'recv.change': '更改',
  ...
  'settings.ttl_5m': '5 分钟',
  'settings.ttl_10m': '10 分钟',
  'settings.ttl_30m': '30 分钟',
  'settings.ttl_1h': '1 小时',
  'settings.ttl_custom': '自定义',
  'settings.custom_lifetime': '自定义时长',
  'settings.seconds': '秒',
...
const Map<String, String> _en = {
  ...
  'recv.submit_hint': 'Press Enter to receive',
  'recv.paste_receive': 'Paste & receive',
  'recv.start': 'Receive',
  ...
  'settings.ttl_5m': '5 minutes',
  'settings.ttl_10m': '10 minutes',
  'settings.ttl_30m': '30 minutes',
  'settings.ttl_1h': '1 hour',
  'settings.ttl_custom': 'Custom',
  'settings.custom_lifetime': 'Custom duration',
  'settings.seconds': 's',
