...
const Map<String, String> _zh = {
  ...
  'tray.show': '显示窗口',
  'tray.quick_send': '快速发送',
  'tray.quit': '退出',
  'basket.title': '快速投递篮',
  'basket.drop_hint': '拖入文件或文件夹即可发送',
  'basket.open_main': '打开主窗口',
  'basket.hide': '隐藏投递篮',
  'basket.pin': '保持置顶',
  'basket.unpin': '取消置顶',
  'basket.retry': '重试',
  'basket.try_again': '重新选择',
  'basket.again': '继续投递',
...
const Map<String, String> _en = {
  ...
  'tray.quick_send': 'Quick send',
  'tray.quit': 'Quit',
  'basket.title': 'Quick Drop',
  'basket.drop_hint': 'Drop files or folders to send',
  'basket.open_main': 'Open main window',
  'basket.hide': 'Hide Quick Drop',
  'basket.pin': 'Keep on top',
  'basket.unpin': 'Stop keeping on top',
  'basket.retry': 'Retry',
  'basket.try_again': 'Choose again',
  'basket.again': 'Send more',
