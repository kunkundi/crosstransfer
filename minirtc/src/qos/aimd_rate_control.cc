...
// Back-off factor lives as a default member initializer on beta_.
...
AimdRateControl::AimdRateControl(bool send_side)
    : min_configured_bitrate_(kCongestionControllerMinBitrate),
      max_configured_bitrate_(DataRate::KilobitsPerSec(200000)),
      current_bitrate_(DataRate::KilobitsPerSec(200000)),
      latest_estimated_throughput_(DataRate::KilobitsPerSec(200000)),
      link_capacity_(),
